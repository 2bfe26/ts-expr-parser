...
Deno.test("[parser] should properly evaluate math expressions", () => {
...
Deno.test("[parser] should properly evaluate math expressions with variables", () => {
...
Deno.test("[parser] should properly evaluate math expressions with functions", () => {
  assertEquals(
...
Deno.test("[parser] should properly evaluate math expressions with nested function", () => {
